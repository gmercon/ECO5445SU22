...
prop_prices_reduced <- read_csv("data/prop_prices_reduced.csv")
...
# pool is categorical, so you will need to turn that into a factor (-2)
...
`Pool actually didn't test significant at 95% (-2)`
